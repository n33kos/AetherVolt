...
var _Entity2 = __webpack_require__(21);
...
var _Prototype = __webpack_require__(19);
...
var _Level2 = __webpack_require__(4);
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function remove(uuid) {
      this.tileTypes = this.tileTypes.filter(function (el) {
        return el.uuid !== uuid;
      });
    }
  }]);
