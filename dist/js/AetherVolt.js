...
var _AiService = __webpack_require__(15);

var _AiService2 = _interopRequireDefault(_AiService);

var _cyclePlayerTurn = __webpack_require__(8);
...
var _Entity2 = __webpack_require__(7);
...
var _class = function _class(GameState) {
  _classCallCheck(this, _class);
...
var _LoadedEntity2 = __webpack_require__(17);
...
var _worldSpaceToCanvas = __webpack_require__(37);
...
exports.default = function () {
  ...
  if (this.GameState.forceMoveAtEndOfTurn && this.attackingPlayer.moves > 0) {
    var startingTile = _getTileWithPlayer2.default.call(this, this.attackingPlayer);
...
var _getRandomIntegerNotEqualTo = __webpack_require__(32);

var _getRandomIntegerNotEqualTo2 = _interopRequireDefault(_getRandomIntegerNotEqualTo);

var _getTileWithPlayer = __webpack_require__(6);

var _getTileWithPlayer2 = _interopRequireDefault(_getTileWithPlayer);

var _handleLightningDischarge = __webpack_require__(33);
...
var _cloneClass = __webpack_require__(18);

var _cloneClass2 = _interopRequireDefault(_cloneClass);

var _DismissedTile = __webpack_require__(38);
...
var _TileType = __webpack_require__(10);
...
var _class = function (_Sprite) {
  ...
  function _class(config) {
    ...
    _this.turbulenceRange = new _Vector2.default(20, 20);
    _this.turbulenceScale = 0;
    _this.turbulenceScaleRange = 0.5;
...
var _BaseService2 = __webpack_require__(5);
...
var _class = function (_BaseService) {
  _inherits(_class, _BaseService);
  ...
  function _class(config) {
    ...
    _this.maxThinkyTime = 200;
    return _this;
  }

  _createClass(_class, [{
    key: 'scheduleAction',
    value: function scheduleAction() {
      window.setTimeout(this.fireAction.bind(this), Math.random() * this.maxThinkyTime);
    }
  }, {
    key: 'fireAction',
    value: function fireAction() {
      ...
      var moveFunction = possibleActions[Math.floor(Math.random() * possibleActions.length)];
      if (moveFunction) moveFunction();
    }
  }, {
    key: 'move',
    value: function move() {
      var sourceTile = _getTileWithPlayer2.default.call(this.GameState.currentLevel, this.GameState.currentLevel.attackingPlayer);
      var targetTile = this.GameState.currentLevel.grid.tiles.find(function (tile) {
        return tile.id === sourceTile.x + '_' + (sourceTile.y + (Math.random() > 0.5 ? -1 : 1));
      });

      if (targetTile && sourceTile) {
        this.GameState.currentLevel.currentAction.actionType = new _ActionType2.default('MOVE');
    ...
    key: 'rotate',
    value: function rotate() {
      var tileToRotate = this.getRandomTileToRotate.call(this);

      if (tileToRotate) {
        this.GameState.currentLevel.currentAction.actionType = new _ActionType2.default('ROTATE');
    ...
    key: 'getRandomTileToRotate',
    value: function getRandomTileToRotate() {
      var tiles = this.GameState.currentLevel.grid.tiles.filter(function (tile) {
        return tile.tileType.type !== 'EMPTY';
      });
    ...
    key: 'place',
    value: function place() {
      var sourceTile = this.GameState.currentLevel.attackingPlayer.hand.tiles[Math.floor(Math.random() * this.GameState.currentLevel.attackingPlayer.hand.tiles.length)];
      var targetTile = this.getEmptyTileToPlace.call(this);
      ...
      if (sourceTile && targetTile) {
        ...
        this.GameState.currentLevel.currentAction.actionType = new _ActionType2.default('PLACE');
    ...
    key: 'getEmptyTileToPlace',
    value: function getEmptyTileToPlace() {
      var tiles = this.GameState.currentLevel.grid.tiles.filter(function (tile) {
        return tile.tileType.type === 'EMPTY' && !tile.placedBy;
      });
      return tiles[Math.floor(Math.random() * tiles.length)] || null;
    }
  }]);
...
var _rectContains = __webpack_require__(11);
...
var AetherVolt = { GameState: _GameState2.default };
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ---- Classes ----
...
var _captains = __webpack_require__(42);

var _captains2 = _interopRequireDefault(_captains);

var _gameState = __webpack_require__(43);

var _gameState2 = _interopRequireDefault(_gameState);

var _levels = __webpack_require__(44);

var _levels2 = _interopRequireDefault(_levels);

var _CaptainFactory = __webpack_require__(45);

var _CaptainFactory2 = _interopRequireDefault(_CaptainFactory);

var _LevelFactory = __webpack_require__(50);
...
var _class = function () {
  function _class() {
    ...
    this.Audio = null;
    this.Canvas = null;
    this.captainFactory = new _CaptainFactory2.default(this);
    this.captains = [];
    this.Controls = null;
  ...
  _createClass(_class, [{
    ...
    value: function init() {
      ...
      this.AiService = new _AiService2.default(this);

      this.Canvas = new _Canvas2.default(this);
      this.Canvas.init();

      this.Controls = new _Controls2.default(this);
      this.Controls.init();

      this.Scene = new _Scene2.default(this);
      this.Scene.init();

      this.Render = new _Render2.default(this);
      this.Render.init();

      this.Update = new _Update2.default(this);
      this.Update.init();
    ...
    key: 'loadCaptains',
    value: function loadCaptains() {
      this.captains.forEach(function (captain) {
        return captain.load();
      });
    }
  }, {
    ...
    value: function loadLevel() {
      ...
      var players = [this.captains[0], this.captains[1]];
...
var _throttleDebounce = __webpack_require__(14);
...
exports.default = function () {
  ...
  var startCell = _getTileWithPlayer2.default.call(this, this.attackingPlayer);
  var endCell = _getTileWithPlayer2.default.call(this, this.defendingPlayer);
...
var _endGame = __webpack_require__(34);

var _endGame2 = _interopRequireDefault(_endGame);

var _fireLightning = __webpack_require__(35);
...
var _Pathfinder = __webpack_require__(39);
...
var _Lightning = __webpack_require__(36);
...
var _PriorityQueue = __webpack_require__(40);
...
var _CreateCaptainService = __webpack_require__(46);

var _CreateCaptainService2 = _interopRequireDefault(_CreateCaptainService);
...
var _class = function () {
  function _class(GameState) {
    ...
    this.GameState = GameState;
    this.createCaptainService = new _CreateCaptainService2.default(GameState);
  }

  _createClass(_class, [{
    key: 'generateCaptain',
    value: function generateCaptain(config) {
...
var _class = function (_BaseService) {
  ...
  _createClass(_class, [{
    key: 'createCaptain',
    value: function createCaptain(config) {
      this.captain = new _Player2.default(_extends({
        GameState: this.GameState
      }, config));
...
var _CreateAvatarService = __webpack_require__(48);

var _CreateAvatarService2 = _interopRequireDefault(_CreateAvatarService);
...
var _class = function () {
  function _class(_ref) {
    var GameState = _ref.GameState,
        ...
        controller = _ref$controller === undefined ? 'AI' : _ref$controller,
        ...
        _ref$spritePath = _ref.spritePath,
        spritePath = _ref$spritePath === undefined ? '' : _ref$spritePath;
    ...
    this.createAvatarService = new _CreateAvatarService2.default(this.GameState);
...
var _getPixelDensity = __webpack_require__(13);
...
var _class = function (_BaseService) {
  ...
  _createClass(_class, [{
    key: 'createAvatar',
    value: function createAvatar(config) {
      var _this2 = this;

      this.avatar = new _Avatar2.default({
        GameState: this.GameState,
        dimensions: new _Vector2.default(64, 128),
        scale: new _Vector2.default(2 * (0, _getPixelDensity2.default)(), 2 * (0, _getPixelDensity2.default)()),
        ...
        onHover: function onHover() {
          ...
          if (_this2.GameState.currentLevel.attackingPlayer.name !== config.player.name) return;

          // Make the move helper visible for the player
          _this2.GameState.currentLevel.tileHelper.initArrowMove(config.player);
        },
        targetPosition: new _Vector2.default(0, 0),
        animations: {
          mouseDown: {
            frames: 12,
            loop: true,
...
var _SpriteButton2 = __webpack_require__(19);
...
var _CreateLevelService = __webpack_require__(51);

var _CreateLevelService2 = _interopRequireDefault(_CreateLevelService);
...
var _class = function () {
  function _class(GameState) {
    ...
    this.GameState = GameState;
    this.createLevelService = new _CreateLevelService2.default(GameState);
  }

  _createClass(_class, [{
    key: 'generateLevel',
    value: function generateLevel(config) {
...
var _Cloud = __webpack_require__(53);
...
var _Hand = __webpack_require__(57);

var _Hand2 = _interopRequireDefault(_Hand);

var _Level = __webpack_require__(58);
...
var _class = function (_BaseService) {
  ...
  _createClass(_class, [{
    key: 'createLevel',
    value: function createLevel(config) {
      this.level = new _Level2.default(_extends({
        GameState: this.GameState
      }, config));
    ...
    key: 'generateLoadFunction',
    value: function generateLoadFunction(config) {
      var _this2 = this;
...
var _randomRange = __webpack_require__(55);
...
var _TileOutline = __webpack_require__(56);
...
var _TileHelper = __webpack_require__(59);
...
var _class = function (_LoadedEntity) {
  ...
  function _class(config) {
    ...
    var _config$name = config.name,
        name = _config$name === undefined ? 'Default Level' : _config$name,
        _config$rows = config.rows,
        rows = _config$rows === undefined ? 4 : _config$rows,
        _config$columns = config.columns,
        columns = _config$columns === undefined ? 4 : _config$columns,
        _config$currentPlayer = config.currentPlayerTurn,
        currentPlayerTurn = _config$currentPlayer === undefined ? 0 : _config$currentPlayer,
        _config$selectedTile = config.selectedTile,
        selectedTile = _config$selectedTile === undefined ? null : _config$selectedTile,
        _config$currentAction = config.currentAction,
        currentAction = _config$currentAction === undefined ? null : _config$currentAction,
        _config$tileHelper = config.tileHelper,
        tileHelper = _config$tileHelper === undefined ? new _TileHelper2.default(config.GameState) : _config$tileHelper,
        _config$attackingPlay = config.attackingPlayer,
        attackingPlayer = _config$attackingPlay === undefined ? null : _config$attackingPlay,
        _config$defendingPlay = config.defendingPlayer,
        defendingPlayer = _config$defendingPlay === undefined ? null : _config$defendingPlay,
        _config$hoveredTile = config.hoveredTile,
        hoveredTile = _config$hoveredTile === undefined ? null : _config$hoveredTile;


    _this.name = name;
    _this.rows = rows;
    _this.columns = columns;
    _this.currentPlayerTurn = currentPlayerTurn;
    _this.selectedTile = selectedTile;
    _this.currentAction = currentAction;
    _this.tileHelper = tileHelper;
    _this.attackingPlayer = attackingPlayer;
    _this.defendingPlayer = defendingPlayer;
    _this.hoveredTile = hoveredTile;
    _this.players = null;
    return _this;
  }
...
var _SpriteButton = __webpack_require__(19);
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    key: 'initArrowMove',
    value: function initArrowMove(player) {
      this.clear();

      this.tile = _getTileWithPlayer2.default.call(this.GameState.currentLevel, player);
      this.currentAction = this.GameState.currentLevel.currentAction;
      this.isMoving = true;

      var avatar = this.tile.player.avatar;
...
var _findTileAtPosition = __webpack_require__(20);

var _findTileAtPosition2 = _interopRequireDefault(_findTileAtPosition);

var _resetHover = __webpack_require__(61);

var _resetHover2 = _interopRequireDefault(_resetHover);

var _setHover = __webpack_require__(62);
